        ...
        <div class="container text-primary">
            <div class="row">
                <div class="col-lg-6 text-center text-lg-left">
                    <p class="mb-75 mb-0">&copy; <?php echo Date('Y') . ' ' . get_bloginfo('name'); ?></p>
                    <p class="d-none mb-75 mb-0">Join us on <a href="#" target="_blank" class="text-primary font-weight-bold">Facebook</a> | <a
                            href="#" target="_blank" class="text-primary font-weight-bold">Instagram</a></p>
                </div>
                <div class="col-lg-6 text-center text-lg-right">
                    <p class="mb-0"><a href="<?php echo esc_url(home_url('/')); ?>/terms-and-conditions"
                                          class="text-primary font-weight-bold">Terms & Conditions</a> | <a
